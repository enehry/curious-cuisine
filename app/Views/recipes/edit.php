    ...
    <div>
      <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
          ...
          <form action="<?= route_to('update-recipe') ?>" method="POST" enctype="multipart/form-data">
            <?= csrf_field() ?>
            ...
            <div class="space-y-3">
              <div class="mb-4">
                ...
                <div class="flex justify-start items-center gap-2 mt-2">
                  <?php if ($recipe['image_url']) : ?>
                    <img src="<?= base_url($recipe['image_url']) ?>" alt="<?= esc($recipe['title']) ?>" class="mr-2 w-32 h-32 object-cover rounded">
                  <?php endif ?>
                  <div id="image-preview" class="mt-2"></div>
                  <div class="text-sm text-gray-500">
                    Upload image to overwrite existing one.
                  </div>
                </div>
              </div>
              <div class="">
                <label for="title" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Recipe title</label>
                <input type="text" name="title" id="title" value="<?= old('title', $recipe['title']) ?>" class="bg-gray-50 border <?= ($validation?->hasError('title')) ? 'border-red-500' : 'border-gray-300' ?> text-gray-900 text-sm rounded-lg focus:ring-red-600 focus:border-red-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500" placeholder="Type recipe title" required="">
              ...
              <div class="flex gap-2">
                <div class="w-full">
                  ...
                  <input type="number" name="preparation" id="preparation" value="<?= old('preparation', $recipe['preparation']) ?>" class="bg-gray-50 border <?= ($validation?->hasError('preparation')) ? 'border-red-500' : 'border-gray-300' ?> text-gray-900 text-sm rounded-lg focus:ring-red-600 focus:border-red-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500" placeholder="How many minutes to prepare? ex. 60">
                ...
                <div class="w-full">
                  ...
                  <input type="number" name="cook" id="cook" value="<?= old('cook', $recipe['cook']) ?>" class="bg-gray-50 border <?= ($validation?->hasError('cook')) ? 'border-red-500' : 'border-gray-300' ?> text-gray-900 text-sm rounded-lg focus:ring-red-600 focus:border-red-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500" placeholder="How many minutes to cook? ex. 60">
                ...
                <div class="w-full">
                  ...
                  <input type="text" name="type" id="type" value="<?= old('type', $recipe['type']) ?>" class="bg-gray-50 border <?= ($validation?->hasError('type')) ? 'border-red-500' : 'border-gray-300' ?> text-gray-900 text-sm rounded-lg focus:ring-red-600 focus:border-red-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500" placeholder="What is the type of this recipe? ex. Break Fast">
              ...
              <div class="">
                ...
                <input type="text" name="description" id="description" value="<?= old('description', $recipe['description']) ?>" class="bg-gray-50 border <?= ($validation?->hasError('description')) ? 'border-red-500' : 'border-gray-300' ?> text-gray-900 text-sm rounded-lg focus:ring-red-600 focus:border-red-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500" placeholder="Type recipe description">
